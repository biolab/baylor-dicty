...
regulons=read.table(paste(path_clusters,"mergedGenes_min18_clusters_smaller.tab",sep=''),
                    header=TRUE,row.names=1, sep="\t")
...
#** Expression colours
col = colorRamp2(c(min_expression,max_expression), c( "cornflowerblue", "khaki1"))
first=TRUE
