...
repsTest<-c('AX4_bio1','AX4_bio2','comH_r1','comH_r2','tagB_bio1','tagB_bio2','tgrC1_r1','tgrC1_r2')
...
phenos<-c(rep(c(1,1,2,2,2,3,3,4,4,5,5,6),2),rep(c(1,2,2,3,4,4,4,4,4,4),4),rep(c(1,2,2,2,2,2,2,2,2,2),2))
